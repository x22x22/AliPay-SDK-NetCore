...
namespace Aop.Api.Request
{
    ...
    public class AlipayUserMemberCardUpdateRequest : IAopRequest<AlipayUserMemberCardUpdateResponse>
    {
        ...
        /// <summary>
        ///     发卡商户信息，json格式。  目前仅支持如下key：  &#61548; merchantUniId：商户唯一标识  &#61548; merchantUniIdType：支持以下3种取值。
        ///     LOGON_ID：商户登录ID，邮箱或者手机号格式；  UID：商户的支付宝用户号，以2088开头的16位纯数字组成；  BINDING_MOBILE：商户支付宝账号绑定的手机号。     注意：
        ...
        public IDictionary<string, string> GetParameters()
        {
            ...
            parameters.Add("issuer_type", IssuerType);
            parameters.Add("level", Level);
            parameters.Add("orrur_time", OrrurTime);
