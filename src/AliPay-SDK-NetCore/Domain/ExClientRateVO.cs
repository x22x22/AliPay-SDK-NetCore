...
namespace Aop.Api.Domain
{
    ...
    public class ExClientRateVO : AopObject
    {
        ...
        /// </summary>
        [XmlElement("base_ccy")]
        [JsonProperty("base_ccy", NullValueHandling = NullValueHandling.Ignore)]
        ...
        /// </summary>
        [XmlElement("bid_rate")]
        [JsonProperty("bid_rate", NullValueHandling = NullValueHandling.Ignore)]
        ...
        [JsonProperty("client_bid_rate", NullValueHandling = NullValueHandling.Ignore)]
        ...
        [JsonProperty("client_offer_rate", NullValueHandling = NullValueHandling.Ignore)]
        ...
        [JsonProperty("generate_date", NullValueHandling = NullValueHandling.Ignore)]
        ...
        /// </summary>
        [XmlElement("mid_rate")]
        [JsonProperty("mid_rate", NullValueHandling = NullValueHandling.Ignore)]
        ...
        [JsonProperty("offer_rate", NullValueHandling = NullValueHandling.Ignore)]
        ...
        [JsonProperty("on_off_shore", NullValueHandling = NullValueHandling.Ignore)]
        ...
        [JsonProperty("origin_rate_inst", NullValueHandling = NullValueHandling.Ignore)]
        ...
        [JsonProperty("origin_rate_ref", NullValueHandling = NullValueHandling.Ignore)]
        ...
        [JsonProperty("quote_ccy", NullValueHandling = NullValueHandling.Ignore)]
        ...
        [JsonProperty("rate_time", NullValueHandling = NullValueHandling.Ignore)]
        ...
        /// </summary>
        [XmlElement("sp_bid")]
        [JsonProperty("sp_bid", NullValueHandling = NullValueHandling.Ignore)]
        ...
        /// </summary>
        [XmlElement("sp_mid")]
        [JsonProperty("sp_mid", NullValueHandling = NullValueHandling.Ignore)]
        ...
        /// </summary>
        [XmlElement("sp_offer")]
        [JsonProperty("sp_offer", NullValueHandling = NullValueHandling.Ignore)]
        ...
        [JsonProperty("standard_product_rate_id", NullValueHandling = NullValueHandling.Ignore)]
        ...
        [JsonProperty("sub_agreement_id", NullValueHandling = NullValueHandling.Ignore)]
