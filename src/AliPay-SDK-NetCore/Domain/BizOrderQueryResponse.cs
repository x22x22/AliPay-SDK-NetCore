...
namespace Aop.Api.Domain
{
    ...
    {
        /// <summary>
        ///     操作动作。  CREATE_SHOP-创建门店，  MODIFY_SHOP-修改门店，  CREATE_ITEM-创建商品，  MODIFY_ITEM-修改商品，  EFFECTIVE_ITEM-上架商品，
        ///     INVALID_ITEM-下架商品，  RESUME_ITEM-暂停售卖商品，  PAUSE_ITEM-恢复售卖商品
        /// </summary>
        [XmlElement("action")]
        ...
        [JsonProperty("biz_context_info", NullValueHandling = NullValueHandling.Ignore)]
        ...
        ///     流水处理结果码
        ///     <a
        ///         href="https://doc.open.alipay.com/doc2/detail.htm?spm=a219a.7629140.0.0.lL9hGI&treeId=78&articleId=103834&docType=1#s2">
        ///         点此查看
        ///     </a>
        /// </summary>
