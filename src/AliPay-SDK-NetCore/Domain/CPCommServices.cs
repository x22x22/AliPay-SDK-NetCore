...
namespace Aop.Api.Domain
{
    ...
    public class CPCommServices : AopObject
    {
		...
		[JsonProperty("external_address_scan_result", NullValueHandling = NullValueHandling.Ignore)]
		...
		[JsonProperty("gmt_created", NullValueHandling = NullValueHandling.Ignore)]
		...
		[JsonProperty("qr_code_expires", NullValueHandling = NullValueHandling.Ignore)]
		...
		[JsonProperty("qr_code_image", NullValueHandling = NullValueHandling.Ignore)]
		...
		[JsonProperty("qr_code_type", NullValueHandling = NullValueHandling.Ignore)]
