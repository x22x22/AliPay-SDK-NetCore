...
namespace Aop.Api.Domain
{
    ...
    public class AntMerchantExpandEnterpriseApplyModel : AopObject
    {
        ...
        [JsonProperty("business_bank_account_info", NullValueHandling = NullValueHandling.Ignore)]
        ...
        [JsonProperty("business_license_info", NullValueHandling = NullValueHandling.Ignore)]
        ...
        [JsonProperty("legal_representative_info", NullValueHandling = NullValueHandling.Ignore)]
