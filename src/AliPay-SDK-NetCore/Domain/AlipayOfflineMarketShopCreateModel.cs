...
namespace Aop.Api.Domain
{
    ...
    /// </summary>
    [Serializable]
    public class AlipayOfflineMarketShopCreateModel : AopObject
    {
        /// <summary>
        ...
        [JsonProperty("biz_version", NullValueHandling = NullValueHandling.Ignore)]
        ...
        [JsonProperty("enterprise_logon_id", NullValueHandling = NullValueHandling.Ignore)]
        ...
        /// <summary>
        ///     营业执照过期时间。格式：2020-10-20。严格按照格式填写。
        /// </summary>
        ...
        [JsonProperty("ref_apply_id", NullValueHandling = NullValueHandling.Ignore)]
