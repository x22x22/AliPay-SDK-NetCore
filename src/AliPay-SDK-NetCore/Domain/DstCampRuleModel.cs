...
namespace Aop.Api.Domain
{
    ...
    public class DstCampRuleModel : AopObject
    {
		...
		[JsonProperty("alipay_cashier", NullValueHandling = NullValueHandling.Ignore)]
		...
		[JsonProperty("prize_count_per_account", NullValueHandling = NullValueHandling.Ignore)]
		...
		[JsonProperty("rule_uuid", NullValueHandling = NullValueHandling.Ignore)]
