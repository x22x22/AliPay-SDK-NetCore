...
namespace Aop.Api.Domain
{
    ...
    public class AlmReportData : AopObject
    {
        ...
        [JsonProperty("date_type", NullValueHandling = NullValueHandling.Ignore)]
        ...
        /// <summary>
        ///     报表数据，只支持整数（可为负），详细见下面描述。  金额单位：分，1万即传 1000000  百分比：乘以1万后的值。例如：50%，则提供 0.5*10000即：5000
        ///     偏离度bp：bp*1万提供。例如：30.5bp，提供值：305000
        /// </summary>
        [XmlElement("report_value")]
        [JsonProperty("report_value", NullValueHandling = NullValueHandling.Ignore)]
