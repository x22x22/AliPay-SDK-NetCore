...
namespace Aop.Api.Domain
{
    ...
    {
        /// <summary>
        ///     手艺人账户名，仅支持小写字母和数字。上限12个小写字母或者数字。举例，若商户在口碑商家的登录账号为 testaop01@alipay.com,手艺人账号名为zhangsan，则手艺人登录口碑商家的账号名为
        ///     testaop01@alipay.com#zhangsan，获取登录密码需要扫商户app的员工激活码。从口碑商家app的员工管理进入员工详情页获取登录密码。
        /// </summary>
        [XmlElement("account")]
        ...
        /// <summary>
        ///     手艺人头像，在商家端手艺人管理和用户端手艺人个人简介中展示手艺人头像 （通过 alipay.offline.material.image.upload
        ///     接口上传图片获取的资源id），上限最大5M,支持bmp,png,jpeg,jpg,gif格式的图片。
        /// </summary>
        [XmlElement("avatar")]
        ...
        [JsonProperty("career_begin", NullValueHandling = NullValueHandling.Ignore)]
        ...
        [JsonProperty("out_craftsman_id", NullValueHandling = NullValueHandling.Ignore)]
        ...
        /// </summary>
        [XmlElement("tel_num")]
        [JsonProperty("tel_num", NullValueHandling = NullValueHandling.Ignore)]
