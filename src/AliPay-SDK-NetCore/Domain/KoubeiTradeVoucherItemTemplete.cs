...
namespace Aop.Api.Domain
{
    ...
    public class KoubeiTradeVoucherItemTemplete : AopObject
    {
        ...
        ///     7-360，单位天。举例，如果是7的话，是到第七天晚上23:59:59失效。商品购买后，没有在有效期内核销，则自动退款给用户。举例：买了一个高级造型师洗剪吹的商品，有效期一个月，如果一个月之后，用户没有使用商品来进行洗剪吹的服务，则自动退款给用户。
        /// </summary>
        [XmlElement("validity_period")]
        [JsonProperty("validity_period", NullValueHandling = NullValueHandling.Ignore)]
