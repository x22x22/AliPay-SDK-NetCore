...
namespace Aop.Api.Domain
{
    ...
    public class KoubeiItemCreateModel : AopObject
    {
        ...
        [JsonProperty("item_detail_url", NullValueHandling = NullValueHandling.Ignore)]
        ...
        [JsonProperty("picture_details", NullValueHandling = NullValueHandling.Ignore)]
        ...
        [JsonProperty("price_mode", NullValueHandling = NullValueHandling.Ignore)]
        ...
        /// </summary>
        [XmlElement("shop_ids")]
        [JsonProperty("shop_ids", NullValueHandling = NullValueHandling.Ignore)]
        ...
        [JsonProperty("trade_voucher_item_template", NullValueHandling = NullValueHandling.Ignore)]
