...
namespace Aop.Api.Domain
{
    ...
    public class MpPrizeInfoModel : AopObject
    {
        ...
        [JsonProperty("certlot_number", NullValueHandling = NullValueHandling.Ignore)]
        ...
        [JsonProperty("frequency_type", NullValueHandling = NullValueHandling.Ignore)]
        ...
        /// <summary>
        ///     奖品id，值由支付宝生成；调用alipay.marketing.campaign.drawcamp.create创建活动时不需要传入；
        ///     调用alipay.marketing.campaign.drawcamp.query接口查询时会返回；调用alipay.marketing.campaign.drawcamp.update接口修改活动时，如果不填prize_id,则会用参数新增一个奖品，并覆盖之前的奖品，如开发者想保留或修改当前活动奖品信息，则在修改接口中此参数必传。
        /// </summary>
        [XmlElement("prize_id")]
        ...
        [JsonProperty("prize_max_award_limit", NullValueHandling = NullValueHandling.Ignore)]
        ...
        [JsonProperty("prize_total", NullValueHandling = NullValueHandling.Ignore)]
