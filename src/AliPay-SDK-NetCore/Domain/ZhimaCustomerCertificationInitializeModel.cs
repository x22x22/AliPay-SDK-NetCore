...
namespace Aop.Api.Domain
{
    ...
    public class ZhimaCustomerCertificationInitializeModel : AopObject
    {
        ...
        [JsonProperty("ext_biz_param", NullValueHandling = NullValueHandling.Ignore)]
        public string ExtBizParam { get; set; }

        /// <summary>
        ///     值为一个json串,必须包含身份类型identity_type,不同的身份类型需要的身份信息不同  当前支持:  身份信息为证件信息identity_type=CERT_INFO:
