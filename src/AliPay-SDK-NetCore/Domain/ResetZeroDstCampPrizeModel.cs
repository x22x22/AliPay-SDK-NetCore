...
namespace Aop.Api.Domain
{
    ...
    public class ResetZeroDstCampPrizeModel : AopObject
    {
        ...
        /// <summary>
        ///     对应的值分别为100,1000,10000,100000  小数点取整，交易金额必须大于1元，最大优惠幅度0.99元，EG：交易金额1.36元，取整后优惠后金额为1元
        ...
        [JsonProperty("reset_zero_amt", NullValueHandling = NullValueHandling.Ignore)]
