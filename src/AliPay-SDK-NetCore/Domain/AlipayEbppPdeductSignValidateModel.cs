...
namespace Aop.Api.Domain
{
    ...
    public class AlipayEbppPdeductSignValidateModel : AopObject
    {
        ...
        [JsonProperty("agent_channel", NullValueHandling = NullValueHandling.Ignore)]
        ...
        [JsonProperty("deduct_type", NullValueHandling = NullValueHandling.Ignore)]
        ...
        [JsonProperty("pay_config", NullValueHandling = NullValueHandling.Ignore)]
        ...
        [JsonProperty("sign_expire_date", NullValueHandling = NullValueHandling.Ignore)]
