...
namespace Aop.Api.Domain
{
    ...
    public class RoyaltyDetailInfos : AopObject
    {
        ...
        [JsonProperty("out_relation_id", NullValueHandling = NullValueHandling.Ignore)]
        ...
        [JsonProperty("trans_in_type", NullValueHandling = NullValueHandling.Ignore)]
        ...
        [JsonProperty("trans_out_type", NullValueHandling = NullValueHandling.Ignore)]
