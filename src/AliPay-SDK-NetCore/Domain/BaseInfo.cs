...
namespace Aop.Api.Domain
{
    ...
    public class BaseInfo : AopObject
    {
        ...
        [JsonProperty("alipay_fuwu_name", NullValueHandling = NullValueHandling.Ignore)]
        ...
        /// </summary>
        [XmlElement("logo_pic")]
        [JsonProperty("logo_pic", NullValueHandling = NullValueHandling.Ignore)]
        public string LogoPic { get; set; }

        /// <summary>
        ///     所属MCCCode，详情可参考
        ///     <a
        ///         href="https://doc.open.alipay.com/doc2/detail.htm?spm=a219a.7629140.0.0.59bgD2&treeId=222&articleId=105364&docType=1#s1  ">
        ///         商家经营类目
        ///     </a>
        /// </summary>
        [XmlElement("mcc_code")]
        [JsonProperty("mcc_code", NullValueHandling = NullValueHandling.Ignore)]
        ...
        [JsonProperty("usage_scenario", NullValueHandling = NullValueHandling.Ignore)]
        ...
        [JsonProperty("web_auth_pic", NullValueHandling = NullValueHandling.Ignore)]
        ...
        [JsonProperty("weixin_public_name", NullValueHandling = NullValueHandling.Ignore)]
