...
namespace Aop.Api.Domain
{
    ...
    public class CPBillSet : AopObject
    {
		...
		[JsonProperty("acct_period", NullValueHandling = NullValueHandling.Ignore)]
		...
		[JsonProperty("bill_entry_amount", NullValueHandling = NullValueHandling.Ignore)]
		...
		[JsonProperty("relate_id", NullValueHandling = NullValueHandling.Ignore)]
		...
		[JsonProperty("release_day", NullValueHandling = NullValueHandling.Ignore)]
		...
		[JsonProperty("remark_str", NullValueHandling = NullValueHandling.Ignore)]
		...
		[JsonProperty("room_address", NullValueHandling = NullValueHandling.Ignore)]
