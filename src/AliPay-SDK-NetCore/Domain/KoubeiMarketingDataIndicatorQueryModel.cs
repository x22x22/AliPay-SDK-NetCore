...
namespace Aop.Api.Domain
{
    ...
    public class KoubeiMarketingDataIndicatorQueryModel : AopObject
    {
        ...
        /// <summary>
        ///     业务类型，可选值有六个  1，MemberQuery 商户会员数据查询  2，MemberQueryByStore 门店会员数据查询  3，TradeQuery 商户交易数据查询  4，TradeQueryByStore
        ///     门店交易数据查询  5，CampaignQuery 商户活动数据查询  6，CampaignQueryByStore 门店活动数据查询
        /// </summary>
        [XmlElement("biz_type")]
