...
namespace Aop.Api.Domain
{
    ...
    public class AlipayMarketingCampaignCashCreateModel : AopObject
    {
        ...
        [JsonProperty("merchant_link", NullValueHandling = NullValueHandling.Ignore)]
        ...
        /// <summary>
        ///     红包发放个数，不同的发奖类型含义不同：  (1) 固定金额：活动总共发放的现金红包个数,最小1个,最大10000000个。 实际的个数限制可能会根据业务进行动态调整。  (2)
        ///     随机金额：用于计算每个随机红包的平均值，但最终发放个数不一定是total_num，可能大于也可能小于。
        /// </summary>
