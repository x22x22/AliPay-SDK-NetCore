...
namespace Aop.Api.Domain
{
    ...
    public class AlipayFundTransToaccountTransferModel : AopObject
    {
		...
		[JsonProperty("payee_real_name", NullValueHandling = NullValueHandling.Ignore)]
		...
		[JsonProperty("payee_type", NullValueHandling = NullValueHandling.Ignore)]
		...
		[JsonProperty("payer_real_name", NullValueHandling = NullValueHandling.Ignore)]
		...
		[JsonProperty("payer_show_name", NullValueHandling = NullValueHandling.Ignore)]
        public string PayerShowName { get; set; }

        /// <summary>
        /// 转账备注（支持200个英文/100个汉字）。  当付款方为企业账户，且转账金额达到（大于等于）50000元，remark不能为空。收款方可见，会展示在收款用户的账单中。
        /// </summary>
        [XmlElement("remark")]
