...
namespace Aop.Api.Domain
{
    ...
    {
        /// <summary>
        ///     查询菜品类型：1- 招牌菜品；2-中游菜品；3-潜力菜品；4-疑问菜品；5-其他菜品，具体看类型范文接口  2-
        ///     如果要查询所有的则传入999。具体的值可以通过koubei.marketing.data.dishdiagnosetype.batchquery来查询，同时会返回类型与说明
        /// </summary>
        [XmlElement("item_diagnose_type")]
        [JsonProperty("item_diagnose_type", NullValueHandling = NullValueHandling.Ignore)]
