...
namespace Aop.Api.Domain
{
    ...
    public class AntMerchantExpandPersonalApplyModel : AopObject
    {
        ...
        [JsonProperty("operator_info", NullValueHandling = NullValueHandling.Ignore)]
        ...
        [JsonProperty("personal_bank_account_info", NullValueHandling = NullValueHandling.Ignore)]
