...
namespace Aop.Api.Domain
{
    ...
    public class CustomsDeclareRecordInfo : AopObject
    {
        ...
        /// <summary>
        ///     发起报关后，海关返回回执中的结果码。目前只有总署的报关，并且总署回执接收成功的请求才会返回此参数  2：电子口岸申报中  3：发送海关成功  4：发送海关失败  100：海关退单  399：海关审结
        ///     小于0的数字：表示处理异常回执     注意：  支付宝原样返回海关返回的数据，参数值以海关的定义为准。
        /// </summary>
        [XmlElement("customs_result_code")]
        [JsonProperty("customs_result_code", NullValueHandling = NullValueHandling.Ignore)]
        ...
        [JsonProperty("customs_result_info", NullValueHandling = NullValueHandling.Ignore)]
        ...
        [JsonProperty("customs_result_return_time", NullValueHandling = NullValueHandling.Ignore)]
