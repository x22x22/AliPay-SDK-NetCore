...
namespace Aop.Api.Domain
{
    ...
    public class SendRule : AopObject
    {
        ...
        [JsonProperty("allow_repeat_send", NullValueHandling = NullValueHandling.Ignore)]
        ...
        [JsonProperty("send_budget", NullValueHandling = NullValueHandling.Ignore)]
        ...
        /// </summary>
        [XmlElement("send_num")]
        [JsonProperty("send_num", NullValueHandling = NullValueHandling.Ignore)]
