...
namespace Aop.Api.Domain
{
    ...
    public class AlipayOfflineMarketShopSummaryBatchqueryModel : AopObject
    {
        ...
        /// <summary>
        /// 门店数据查询类型，根据类型可以返回指定的门店数据，目前支持的类型如下：  BRAND_RELATION ： 品牌商关联店铺  MALL_SELF ：MALL自己的门店  MALL_RELATION：MALL关联下的门店  MERCHANT_SELF:商户自己的门店
        /// </summary>
		...
		[JsonProperty("related_partner_id", NullValueHandling = NullValueHandling.Ignore)]
