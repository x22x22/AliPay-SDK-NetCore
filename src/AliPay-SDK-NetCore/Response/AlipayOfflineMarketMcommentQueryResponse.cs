...
namespace Aop.Api.Response
{
    ...
    public class AlipayOfflineMarketMcommentQueryResponse : AopResponse
    {
        ...
        /// <summary>
        ///     注意：该字段描述评论状态。目前该字段区分2种类型状态  当comment_status='NOCOMMENT' 标识该笔交易未发生过评论。  当comment_status='HASCOMMENT'
        ///     标识该笔交易已经评论。评论状态正常  当comment_status='DELETED'标识该笔交易曾经评论过，当前时间点，该评论已经删除
        /// </summary>
        ...
        [JsonProperty("comment_time", NullValueHandling = NullValueHandling.Ignore)]
