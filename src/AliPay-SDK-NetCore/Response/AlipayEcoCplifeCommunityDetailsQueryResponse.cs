...
namespace Aop.Api.Response
{
    ...
    public class AlipayEcoCplifeCommunityDetailsQueryResponse : AopResponse
    {
        ...
        [JsonProperty("community_status", NullValueHandling = NullValueHandling.Ignore)]
        ...
        /// </summary>
        [XmlElement("isv_pid")]
        [JsonProperty("isv_pid", NullValueHandling = NullValueHandling.Ignore)]
        ...
        [JsonProperty("merchant_firm_name", NullValueHandling = NullValueHandling.Ignore)]
