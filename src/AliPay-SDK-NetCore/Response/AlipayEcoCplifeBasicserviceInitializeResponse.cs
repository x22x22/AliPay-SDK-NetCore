...
namespace Aop.Api.Response
{
    ...
    public class AlipayEcoCplifeBasicserviceInitializeResponse : AopResponse
    {
        ...
        [JsonProperty("bill_pay_auth_url", NullValueHandling = NullValueHandling.Ignore)]
        ...
        ///     等待提起上线申请（目前支持开发者调用alipay.eco.cplife.basicservice.modify接口发起上线申请）  WAIT_AUTH_TO_PLATFORM - 等待物业授权给支付宝社区平台
        ///     WAIT_CONFIRMATION - 等待相关方确认  WAIT_AUDITING - 等待审核
        /// </summary>
