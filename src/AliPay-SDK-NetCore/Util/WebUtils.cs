...
namespace Aop.Api.Util
{
    ...
    public sealed class WebUtils
    {
        ...
        public string DoPost(string url, IDictionary<string, string> parameters, string charset)
        {
            ...
            var reqStream = reqTaskStream.Result;
            ...
            var rsp = (HttpWebResponse) rspTask.Result;
            //临时
        ...
        public string DoPost(string url, IDictionary<string, string> textParams,
            IDictionary<string, FileItem> fileParams, string charset)
        {
            // 如果没有文件参数，则走普通POST请求
        ...
        public static string BuildQuery(IDictionary<string, string> parameters, string charset)
        {
            ...
            while (dem.MoveNext())
            {
                ...
                if (!string.IsNullOrEmpty(name) && !string.IsNullOrEmpty(value))
                {
                    ...
                    var encodedValue = WebUtilitys.UrlEncode(value, Encoding.GetEncoding(charset));
